...
const AboutPage = () => {
  return (
    <div className="font-sans min-h-screen bg-inherit text-inherit transition-colors duration-300">
      {/* Hero Section */}
      <section
        className="relative overflow-hidden
                   flex flex-col items-center justify-center text-center
                   py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8
      ...
      >
        ...
        <div
          className="absolute inset-0 -z-10 pointer-events-none
                     ...
                     dark:from-emerald-900/30 dark:via-green-900/20 dark:to-teal-900/30"
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full">
          ...
          <div
            className="inline-flex items-center gap-2
                       ...
                       mb-4 sm:mb-6 shadow-md
                       bg-gradient-to-r from-emerald-50 via-white to-green-50
                       dark:from-emerald-900/40 dark:via-gray-900/30 dark:to-green-900/40"
          >
            <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-emerald-500 dark:bg-emerald-400 rounded-full animate-pulse" />
            <span className="hidden sm:inline text-emerald-700 dark:text-emerald-300">
              Powered by AI Technology
            </span>
            <span className="sm:hidden text-emerald-700 dark:text-emerald-300">
              AI Technology
            </span>
          </div>
          ...
          >
            About{' '}
            <span
              className="bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500
                         dark:from-emerald-400 dark:via-green-400 dark:to-teal-400
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0">
            ...
            <Link
              href="/contact"
              className="group border-2 border-emerald-500/20 dark:border-emerald-400/20
      ...
      {/* Mission Section */}
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-inherit text-inherit backdrop-blur-sm relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500" />
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-inherit text-inherit px-3 py-1 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
            <span className="w-1.5 h-1.5 text-inherit bg-inherit rounded-full" />
            Our Mission
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 text-inherit bg-inherit px-2 sm:px-0">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-100">
              Why Choose <span className="text-emerald-600 dark:text-emerald-400">ExpenseTracker AI?</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-green-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
            ...
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1">
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-teal-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
              <div className="relative z-10">
            ...
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1">
              <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-emerald-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
              <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900 dark:text-gray-100">
              Built for the <span className="text-emerald-600 dark:text-emerald-400">Future</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 p-8 rounded-2xl border border-emerald-100 dark:border-emerald-800/50">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-teal-500 dark:bg-teal-400 rounded-full" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">Free</div>
